...
# Bolt: Compute dataclass fields once at module load to avoid O(n) reflection on every request
...
async def get_cards(
    ...
    # Bolt: Offload synchronous meilisearch client call to thread pool to prevent blocking FastAPI event loop
