...
async def get_cards(
    ...
    # ⚡ Performance Optimization: Wrap synchronous Meilisearch network call in asyncio.to_thread
    # to prevent blocking the FastAPI/uvicorn event loop during card fetches.
